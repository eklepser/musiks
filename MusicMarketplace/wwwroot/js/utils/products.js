...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        window.fillEditTicketForm = (item) => window.ProductForms.fillEditForm(item, 'ticket');
        window.fillEditClothingForm = (item) => window.ProductForms.fillEditForm(item, 'clothing');
        window.fillEditAccessoryForm = (item) => window.ProductForms.fillEditForm(item, 'accessory');
